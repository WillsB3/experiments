...
var bounds = new PIXI.Rectangle(-BOUNDS_PADDING, -BOUNDS_PADDING, 
    renderer.width + BOUNDS_PADDING * 2, renderer.height + BOUNDS_PADDING * 2);
...
function init() {
  ...
  for (var i = 0; i < TOTAL_PARTICLES; i++) {
    ...
    particle.speed = getRandBetween(3, 10) * 0.3;
